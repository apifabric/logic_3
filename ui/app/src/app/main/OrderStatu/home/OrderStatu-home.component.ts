...
@Component({
  selector: 'OrderStatu-home',
  templateUrl: './OrderStatu-home.component.html',
  styleUrls: ['./OrderStatu-home.component.scss']
})
export class OrderStatuHomeComponent implements AfterViewInit {
