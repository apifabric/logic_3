...
resourcename="logic3"  # lower case, only
resourcegroup="logic3_rg"
...
# git clone https://github.com/apilogicserver/logic3.git
# cd logic3
...
az group create --name logic3_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group logic3_rg --sku S1 --is-linux
az container create --resource-group logic3_rg --name logic3 --image apilogicserver/logic3:latest --dns-name-label logic3 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//logic3.westus.azurecontainer.io:5656'
